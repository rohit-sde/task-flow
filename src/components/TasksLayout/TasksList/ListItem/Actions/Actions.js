        ...
        <div className={classes.Actions}>
            {!obj.isExpired ? (
                <div
                    className={
                        classes.Done +
                        (props.task.is_completed ? " " + classes.NoPointer : "")
                    }
                    data-taskdone={props.task.is_completed ? "1" : "0"}
                    ref={doneRef}
                    onClick={
                        !props.task.is_completed
                            ? doneHandler.bind(null, obj)
                            : null
                    }
                >
                    <IconContext.Provider value={{ size: "1.5em" }}>
                        <IoMdDoneAll
                            tabIndex={!props.task.is_completed ? 0 : null}
                        />
            ...
            <div className={classes.EditDelete}>
                {!props.task.is_completed && !obj.isExpired && (
                    <div
                        ...
                        ref={editRef}
                        onClick={editHandler.bind(null, obj)}
                    >
                        <IconContext.Provider value={{ size: "1.5em" }}>
                            <BiEdit tabIndex="0" />
                        </IconContext.Provider>
