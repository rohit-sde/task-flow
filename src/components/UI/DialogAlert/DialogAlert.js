...
const DialogAlert = (props) => {
    ...
    const textSuccess =
        props.textSuccess !== undefined ? props.textSuccess : "OK";
    const textFail = props.textFail !== undefined ? props.textFail : "CANCEL";
    const cbSuccess =
        props.cbSuccess !== undefined
            ? props.cbSuccess
            : cbFailHandler.bind(null, props.updateBackdrop);
    const cbFail =
        props.cbFail !== undefined
            ? props.cbFail
            : cbFailHandler.bind(null, props.updateBackdrop);
        ...
        <div className={classes.DialogAlert}>
            <div className={classes.Title}>
                ...
                <div
                    ...
                    onClick={cbFail.bind(null, props.updateBackdrop)}
                >
                ...
                <div>
                    <div>
                        <button
                            ...
                            onClick={cbSuccess.bind(null, props.updateBackdrop)}
                        >
                            {textSuccess}
                        </button>
                    </div>
