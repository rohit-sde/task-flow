        ...
        <div className={classes.FormSignup}>
            ...
            <form id="signupForm">
                ...
                <Button
                    id="signup"
                    onClick={(e) => {
                        const formResetFun = formReset.bind(
                            null,
                            setValueRef,
                            setMessage
                        );
    ...
    switch (what) {
        ...
        case "pass":
            if (text === "") error = "Password is required.";
                ...
                error = "Use at least 1 lowercase alphabet.";
            else if (!/[A-Z]/.test(text))
                error = "Use at least 1 uppercase alphabet.";
            else if (!/[0-9]/.test(text))
                error = "Use at least 1 numeric character.";
            else if (!/[!@#$%^&*()]/.test(text))
                error = "Use at least 1 character: !@#$%^&*()";
            return error;
