...
export const login = (
    ...
    return (dispatch, getState) => {
        ...
        if (
            emailRef.current.dataset.checkValidation !== undefined &&
            passRef.current.dataset.checkValidation !== undefined
        ) {
            if (
                emailRef.current.dataset.error === "false" &&
                passRef.current.dataset.error === "false"
            ) {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    if (res.data.status) {
                        ...
                        if (
                            /\[Something went wrong with Email Server.\]/.test(
                                res.data.message
                            )
                        ) {
                            // history.push('/login')
